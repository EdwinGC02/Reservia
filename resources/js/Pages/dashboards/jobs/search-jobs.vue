<script setup>
import { JobTable } from "@/shared/data/dashboards/jobs/searchjobsdata";
...
let diffTolltips = [9000, 30000]
let min = 7000
let max = 40000
</script>

<template>
    <Head title="Search-Jobs | Vyzor - Laravel & Vue " />
                ...
                <div class="card-body p-0">
                    <div class="py-4 px-sm-4 p-3 border-bottom">
                        ...
                        <div class="px-sm-2 px-0 py-3 pb-0">
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="c-1" checked>
                                <label class="form-check-label flex-grow-1" for="c-1">
                                    Software Engineer
                                </label>
                                <span class="badge bg-light text-default fw-500 ">2,712</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="c-2">
                                <label class="form-check-label flex-grow-1" for="c-2">
                                    Data Analyst
                                </label>
                                <span class="badge bg-light text-default fw-500 ">536</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="c-3" checked>
                                <label class="form-check-label flex-grow-1" for="c-3">
                                    Product Manager
                                </label>
                                <span class="badge bg-light text-default fw-500 ">18,289</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="c-4" checked>
                                <label class="form-check-label flex-grow-1" for="c-4">
                                    UI/UX Designer
                                </label>
                                <span class="badge bg-light text-default fw-500 ">3,453</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="c-5">
                                <label class="form-check-label flex-grow-1" for="c-5">
                                    Marketing Specialist
                                </label>
                                <span class="badge bg-light text-default fw-500 ">7,165</span>
                            </div>
                            <div class="collapse" id="category-more">
                                <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                    <input class="form-check-input" type="checkbox" value="" id="c-6">
                                    <label class="form-check-label flex-grow-1" for="c-6">
                                        HR Manager
                                    </label>
                                    <span class="badge bg-light text-default fw-500 ">5,964</span>
                                </div>
                                <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                    <input class="form-check-input" type="checkbox" value="" id="c-7">
                                    <label class="form-check-label flex-grow-1" for="c-7">
                                        Full Stack Developer
                                    </label>
                                    <span class="badge bg-light text-default fw-500 ">2,123</span>
                                </div>
                                <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                    <input class="form-check-input" type="checkbox" value="" id="c-8">
                                    <label class="form-check-label flex-grow-1" for="c-8">
                                ...
                                <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                    ...
                                    <label class="form-check-label flex-grow-1" for="c-9">
                                        Sales Manager
                                    </label>
                                    <span class="badge bg-light text-default fw-500 ">2,123</span>
                                </div>
                                <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                    ...
                                    <label class="form-check-label flex-grow-1" for="c-10">
                    ...
                    <div class="py-4 px-sm-4 p-3 border-bottom">
                        ...
                        <div class="px-sm-2 px-0 py-3 pb-0">
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                ...
                                <label class="form-check-label flex-grow-1" for="j-1">
                                    Day Shift
                                </label>
                                <span class="badge bg-light text-default fw-500 ">512</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="j-2" checked>
                                <label class="form-check-label flex-grow-1" for="j-2">
                                    Night Shift
                                </label>
                                <span class="badge bg-light text-default fw-500 ">2,186</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="j-3" checked>
                                <label class="form-check-label flex-grow-1" for="j-3">
                                    Flexible
                                </label>
                                <span class="badge bg-light text-default fw-500 ">734</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="j-4">
                                <label class="form-check-label flex-grow-1" for="j-4">
                                    Rotational
                                </label>
                                <span class="badge bg-light text-default fw-500 ">16</span>
                            </div>
                        </div>
                    </div>
                    <div class="py-4 px-sm-4 p-3 border-bottom">
                    ...
                    <div class="py-4 px-sm-4 p-3 border-bottom">
                        ...
                        <div class="px-sm-2 px-0 py-3 pb-0">
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                ...
                                <label class="form-check-label flex-grow-1" for="q-1">
                                    Computer Science
                                </label>
                                <span class="badge bg-light text-default fw-500 ">16,563</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-2" checked>
                                <label class="form-check-label flex-grow-1" for="q-2">
                                    Marketing
                                </label>
                                <span class="badge bg-light text-default fw-500 ">15,234</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-3">
                                <label class="form-check-label flex-grow-1" for="q-3">
                                    Design
                                </label>
                                <span class="badge bg-light text-default fw-500 ">6,278</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-4" checked>
                                <label class="form-check-label flex-grow-1" for="q-4">
                                    Business
                                </label>
                                <span class="badge bg-light text-default fw-500 ">4,531</span>
                            </div>
                            <div class="form-check  mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-5">
                                <label class="form-check-label flex-grow-1" for="q-5">
                                    HR Management
                                </label>
                                <span class="badge bg-light text-default fw-500 ">2,405</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-6">
                                <label class="form-check-label flex-grow-1" for="q-6">
                                    Product
                                </label>
                                <span class="badge bg-light text-default fw-500 ">453</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-7">
                                <label class="form-check-label flex-grow-1" for="q-7">
                                    Web Development
                                </label>
                                <span class="badge bg-light text-default fw-500 ">123</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-8">
                                <label class="form-check-label flex-grow-1" for="q-8">
                                    IT
                                </label>
                                <span class="badge bg-light text-default fw-500 ">422</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="q-9">
                                <label class="form-check-label flex-grow-1" for="q-9">
                                    Customer Service
                                </label>
                                <span class="badge bg-light text-default fw-500 ">256</span>
                            </div>
                        </div>
                    </div>
                    <div class="py-4 px-sm-4 p-3">
                        ...
                        <div class="px-sm-2 px-0 py-3 pb-0">
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                ...
                                <label class="form-check-label flex-grow-1" for="e-1">
                                    1-3 years
                                </label>
                                <span class="badge bg-light text-default fw-500 ">156</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="e-2">
                                <label class="form-check-label flex-grow-1" for="e-2">
                                    2-4 years
                                </label>
                                <span class="badge bg-light text-default fw-500 ">632</span>
                            </div>
                            <div class="form-check mb-2 d-flex gap-2 flex-wrap">
                                <input class="form-check-input" type="checkbox" value="" id="e-3" checked>
                                <label class="form-check-label flex-grow-1" for="e-3">
                                    3-5 years
                                </label>
                                <span class="badge bg-light text-default fw-500 ">32</span>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="e-4" checked>
                                <label class="form-check-label flex-grow-1" for="e-4">
                                    4-6 years
                                </label>
                                <span class="badge bg-light text-default fw-500 ">54</span>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="e-5" checked>
                                <label class="form-check-label flex-grow-1" for="e-5">
                                    5+ years
                                </label>
                                <span class="badge bg-light text-default fw-500 ">44</span>
                            </div>
                        </div>
                    </div>
                </div>
