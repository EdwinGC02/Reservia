...
export const Responsibilities = [
    { id: 1, class: "", title: "Write clean, scalable, and efficient code for a variety of projects." },
    { id: 2, class: "border-top-0", title: "Design and develop software solutions, applications, and systems from scratch." },
    { id: 3, class: "border-top-0", title: "Work closely with designers, product managers, and other developers to build user-friendly, high-performance web applications." },
    { id: 4, class: "border-top-0", title: "Participate in code reviews, testing, and debugging processes." },
    { id: 5, class: "border-top-0", title: "Contribute to the design and architecture of new software features." },
    { id: 7, class: "border-top-0", title: "Collaborate with the DevOps team to ensure the proper deployment and scalability of applications." },
    { id: 8, class: "border-top-0", title: "Ensure that applications are optimized for maximum speed and scalability." },
    { id: 9, class: "border-top-0", title: "Stay up-to-date with the latest software development trends, tools, and technologies." },
    { id: 10, class: "border-top-0", title: "Participate in the full software development lifecycle (SDLC), from planning through deployment." }
],
    Qualifications = [
        { id: 1, class: "", title: "Bachelor’s degree in Computer Science, Information Technology, or related field (or equivalent experience)." },
        { id: 2, class: "border-top-0", title: "Proven experience as a Software Developer or similar role." },
        { id: 3, class: "border-top-0", title: "Strong knowledge of programming languages such as JavaScript, Python, Ruby, or Java." },
        { id: 4, class: "border-top-0", title: "Familiarity with frameworks like React, Node.js, Angular, or Vue.js." },
        { id: 5, class: "border-top-0", title: "Experience with databases (SQL, NoSQL, MongoDB)." },
        { id: 6, class: "border-top-0", title: "Experience with version control systems like Git." },
        { id: 7, class: "border-top-0", title: "Ability to work collaboratively in a team environment and communicate technical concepts to non-technical stakeholders." },
        { id: 8, class: "border-top-0", title: "Strong problem-solving skills and attention to detail." },
        { id: 9, class: "border-top-0", title: "Knowledge of Agile methodologies and practices." }
    ],
    InfoList = [
        { id: 1, iconClass: 'ri-time-line', label: '09:30 AM - 06:00 PM' },
        { id: 2, iconClass: 'bi bi-mortarboard', label: 'Graduate and Above' },
        { id: 3, iconClass: 'bi bi-calendar', label: '5 Working Days' },
        { id: 4, iconClass: 'bi bi-person-check', label: 'Bachelors Preferred' },
    ],
    Benefits = [
