                    ...
                    <TableComponent tableClass="table text-nowrap" :rows="cart.cartData" v-slot:cell="{ row }">
                        ...
                        <td :class="row.tdClass">
                            <div
                                ...
                                <Quantity decClass="badge bg-white p-2 border text-muted fs-13 product-quantity-minus"
                                    inputClass="form-control form-control-cart border-0 text-center w-100 shadow-none"
                                    incClass="badge bg-white p-2 border text-muted fs-13 product-quantity-plus" :initialValue="row.quantity"  />
                            </div>
                        </td>
                        <td :class="row.tdClass">
            ...
            <div class="card custom-card">
                ...
                <div class="card-footer d-grid">
                    ...
                    <Link :href="`${baseUrl}/dashboards/ecommerce/checkout`"
                        ...
                        checkout<i class="ti ti-arrow-narrow-right ms-1"></i></Link>
                </div>
            </div>
        </div>
    </div>
