                                ...
                                <div class="d-flex align-items-center justify-content-center gap-2 mt-5 flex-wrap">
                                    <Link :href="`${baseUrl}/dashboards/ecommerce/cart`"
                                        class="btn btn-primary btn-lg btn-w-lg border"><i
                                            class="ti ti-shopping-cart mx-1"></i>Add To Cart</Link>
                                    <Link :href="`${baseUrl}/dashboards/ecommerce/checkout`"
                                        class="btn btn-primary btn-lg btn-w-lg border">Buy Now</Link>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-5">
                                        <div class="col-xl-6">
                                            ...
                                            <TableComponent
                                                ...
                                                theadClass="d-none" :rows="productDetails.productDetailsdata"
                                                v-slot:cell="{ row }">
                                                    ...
                                                    <div class="d-flex flex-fill align-items-start gap-3">
                                                        <div>
                                                            <span class="avatar avatar-md avatar-rounded">
                                                                <BaseImg src="/images/faces/15.jpg" alt=""/>
                                                            </span>
                                                        </div>
                                                         <div class="lh-1 me-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="products-review-images">
                                                                <a href="#!" class="me-1" @click="(e)=>e.preventDefault()" >
                                                                    <BaseImg src="/images/ecommerce/jpg/1.jpg" alt=""/>
                                                                </a>
                                                                <a href="#!"  @click="(e)=>e.preventDefault()" >
                                                                    <BaseImg src="/images/ecommerce/jpg/2.jpg" alt=""/>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div
