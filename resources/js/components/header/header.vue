                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        <div class="p-3 bg-primary text-fixed-white position-relative z-2">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <Link :href="`${baseUrl}/dashboards/ecommerce/products/`"
                                            ...
                                            <div class="d-flex align-items-start justify-content-between mb-3">
                                                <div class="fs-14 fw-medium w-75">
                                                    <div class="text-truncate">
                                                        <Link :href="`${baseUrl}/dashboards/ecommerce/cart/`">{{ item.name }}
                                                        </Link>
                                                    </div>
                        ...
                        <div class="p-3 empty-header-item border-top position-relative z-2" v-if="notificationNotes.length">
                            <div class="text-center d-grid">
                                <Link :href="`${baseUrl}/dashboards/ecommerce/checkout/`" class="btn btn-primary btn-wave">
                                    Proceed to
                                    checkout</Link>
                            </div>
                        </div>
                ...
                <ul class="list-unstyled mb-0">
                    <li>
                        <ul class="list-unstyled mb-0 sub-list">
                            <li>
                                <Link class="dropdown-item d-flex align-items-center" :href="`${baseUrl}/pages/profile`"><i
                    ...
                    <li>
                        <Link :href="`${baseUrl}/pages/authentication/sign-in/cover`" class="dropdown-item d-flex align-items-center"><i
