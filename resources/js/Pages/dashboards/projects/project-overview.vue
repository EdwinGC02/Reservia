<script setup>
import * as ProjectOverview from "@/shared/data/dashboards/projects/projectoverviewdata";
...
<template>
    <Head title="Projects Overview | Vyzor - Laravel & Vue " />
        ...
        <div class="col-xxl-6">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    ...
                    <div class="btn-list">
                        <Link :href="`${baseUrl}/dashboards/projects/create-project`" class="btn btn-sm btn-primary btn-wave"><i
                                class="ri-add-line align-middle me-1 fw-medium"></i>Create Project</Link>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-5 mb-4 flex-wrap">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span class="avatar avatar-md avatar-rounded me-1"><BaseImg src="/images/faces/11.jpg" alt=""/></span>
                            ...
                            <div>
                                ...
                                <p class="project-activity-media mb-0" v-if="idx.attachment">
                                    <a href="javascript:void(0);">
                                        <BaseImg src="/images/media/file-manager/3.png" alt="" class="img-fluid bg-light"/>
                                    </a>
                ...
                <div class="card-footer">
                    <div class="d-sm-flex align-items-center lh-1">
                        <div class="me-sm-2 mb-2 mb-sm-0 p-1 rounded-circle bg-primary-transparent d-inline-block">
                            <BaseImg src="/images/faces/5.jpg" alt="" class="avatar avatar-sm avatar-rounded"/>
                        </div>
                        <div class="flex-fill">
