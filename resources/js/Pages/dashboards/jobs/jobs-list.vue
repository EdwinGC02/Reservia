                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <TableComponent tableClass="table text-nowrap" :showCheckbox="true"
                            :headers="[{ text: 'Job Title', thClass: '' }, { text: 'Company', thClass: '' }, { text: 'Department', thClass: '' }, { text: 'Applications', thClass: '' }, { text: 'Vacancies', thClass: '' }, { text: 'Status', thClass: '' }, { text: 'Job Type', thClass: '' }, { text: 'Posted Date', thClass: '' }, { text: 'Action', thClass: '' },]"
                            ...
                            <td>
                                <Link :href="`${baseUrl}/dashboards/jobs/job-details`"
