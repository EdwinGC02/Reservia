...
export const Pieimgoptions = {
	...
	fill: {
		...
		opacity: 0.85,
		image: {
			src: [`${__BASE_PATH__}/images/media/media-21.jpg`, `${__BASE_PATH__}/images/media/media-21.jpg`, `${__BASE_PATH__}/images/media/media-21.jpg`, `${__BASE_PATH__}/images/media/media-21.jpg`],
			width: 25
		},
	},
	stroke: {
