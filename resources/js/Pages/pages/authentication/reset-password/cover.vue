                        ...
                        <div class="card-body p-5">
                            ...
                            <form @submit.prevent="onSubmit">
                                <div class="row gy-3">
                                    <!-- Current Password -->
                                    <div class="col-xl-12">
                                        <label for="reset-password" class="form-label text-default">Current
                                            Password</label>
                                        <div class="position-relative">
                                            <input :type="passwordVisibility.current ? 'text' : 'password'"
                                                id="currentPassword" placeholder="Current password"
                                                class="form-control form-control-lg" v-model="currentPassword" />
                                            <a href="#!" @click.prevent="togglePasswordVisibility('current')"
                                                class="show-password-button text-muted" id="button-addon2">
                                                <i :class="passwordVisibility.current ? 'ri-eye-line' : 'ri-eye-off-line'"
                                    ...
                                    <div class="col-xl-12">
                                        <label for="reset-newpassword" class="form-label text-default">New
                                            Password</label>
                                        <div class="position-relative">
                                            <input :type="passwordVisibility.new ? 'text' : 'password'" id="newPassword"
                                                placeholder="New password" class="form-control form-control-lg"
                                                v-model="newPassword" />
                                            <a href="#!" @click.prevent="togglePasswordVisibility('new')"
                                                class="show-password-button text-muted" id="button-addon21">
                                                <i :class="passwordVisibility.new ? 'ri-eye-line' : 'ri-eye-off-line'"
                                                    class="align-middle"></i>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <a href="#!" @click.prevent="togglePasswordVisibility('confirm')"
                                                class="show-password-button text-muted" id="button-addon22">
                                                <i :class="passwordVisibility.confirm ? 'ri-eye-line' : 'ri-eye-off-line'"
                                                    class="align-middle"></i>
                                            </a>
                                        </div>
                            ...
                            <div class="text-center mt-3 fw-medium">
                                Dont want to reset? <Link :href="`${baseUrl}/pages/authentication/sign-in/basic`"
