...
const items = [
    ...
    { src: `${__BASE_PATH__}/images/media/media-26.jpg`, w: 500, h: 320, thumbnail: `${__BASE_PATH__}/images/media/media-26.jpg`, alt: 'alt' },
    { src: `${__BASE_PATH__}/images/media/media-32.jpg`, w: 500, h: 320, thumbnail: `${__BASE_PATH__}/images/media/media-32.jpg`, alt: 'alt' },
    { src: `${__BASE_PATH__}/images/media/media-30.jpg`, w: 500, h: 320, thumbnail: `${__BASE_PATH__}/images/media/media-30.jpg`, alt: 'alt' },
    { src: `${__BASE_PATH__}/images/media/media-31.jpg`, w: 500, h: 320, thumbnail: `${__BASE_PATH__}/images/media/media-31.jpg`, alt: 'alt' },
    { src: `${__BASE_PATH__}/images/media/media-46.jpg`, w: 500, h: 320, thumbnail: `${__BASE_PATH__}/images/media/media-46.jpg`, alt: 'alt' },
    { src: `${__BASE_PATH__}/images/media/media-59.jpg`, w: 500, h: 320, thumbnail: `${__BASE_PATH__}/images/media/media-59.jpg`, alt: 'alt' },
