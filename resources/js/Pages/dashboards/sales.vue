...
<template>
    ...
    <Head title="Sales | Vyzor - Laravel & Vue " />
    <!-- Start::app-content -->
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        ...
        <div class="d-flex align-items-center flex-wrap">
            <div class="form-group">
                <Datepicker placeholder="Search By Date Range" :enable-time-picker="false" class="form-control breadcrumb-input border-0 bg-white custom-date-input ps-0" autoApply v-model="date" range />
            </div>
                    ...
                    <div class="row">
                        <div class='col-xl-12 col-md-6' v-for='(idx, index) in salesData.SalesCard' :key='index'>
                            <SpkReuseblejobs titleClass="fs-13 fw-medium mb-0" :listCard="true"
                                :cardClass="`card ${idx.cardClass}`" :imageIcon="false" :list="idx" :NoCountUp="true" />
                        </div>
                    </div>
                </div>
                <div class="col-xl-9">
                    <div class="card custom-card">
                        ...
                        <div class="card-body pb-0 pt-5">
                            <div id="sales-overview">
                                <apexchart height="380px" type="line" :options="salesData.overviewoptions"
                    ...
                    <div class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                        <div class="card-body">
                            <div class="dashboard-banner-card-background">
                                <BaseImg src="/images/media/backgrounds/8.png" alt="" />
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body pb-0 p-0">
                            <div id="visitors-report">
                                <apexchart height="335px" type="radar" :options="salesData.visitorsoptions"
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="lh-1">
                                    <span class="avatar avatar-lg bg-light border border-dashed p-1">
                                        <BaseImg :src="product.image" :alt="product.title" />
                                    </span>
                                </div>
                                <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                <div class="lh-1">
                                    <span :class="company.avatarClass">
                                        <BaseImg :src="company.imgSrc" alt="" />
                                    </span>
                                </div>
                                <div class="flex-fill">
                        ...
                        <td :class="row.tableClass">
                            <div class="avatar-list-stacked">
                                <span v-for="(image, index) in row.avatars" :key="index"
                                    ...
                                    <BaseImg :src="image.src" :alt="image.alt" />
                                </span>
                            </div>
                        </td>
                        <td :class="row.tableClass">
