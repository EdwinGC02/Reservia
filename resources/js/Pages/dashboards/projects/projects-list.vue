...
const ProjectselectValue = ref('Date Added')
const Projectselectdata = ['Newest', 'Date Added', 'Type', 'A - Z']
</script>
            ...
            <div class="card custom-card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 projectlist">
                        <div class="d-flex gap-1 project-list-main d-inline-flex text-nowrap flex-sm-nowrap flex-wrap">
                            <Link :href="`${baseUrl}/dashboards/projects/create-project`" class="btn btn-primary me-2"><i
                                class="ri-add-line me-1 fw-medium align-middle"></i>New Project</Link>
            ...
            <div class="card custom-card overflow-hidden">
                <div class="card-body p-0">
                    <TableComponent tableClass="table text-nowrap"
                        ...
                        :rows="ProjectList.ProjectListDat" v-slot:cell="{ row }">
