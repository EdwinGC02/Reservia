...
export const MENUITEMS = [
    ...
    {
        title: "Maestras", icon: Svgicons.Applicationicon, type: "sub", active: false, selected: false, dirchange: false, children: [

            // {
            //     title: "Crypto", type: "sub", badgetxt: badgeSucccess, icon: Svgicons.Cryptoicon, active: false, selected: false, dirchange: false, children: [

            //         { path: `${baseUrl}/productos`, type: "link", active: false, selected: false, dirchange: false, title: "Productos" },

            //     ],
            // },
            { path: `${baseUrl}/productos`, icon: Svgicons.Salesicon, type: "link", active: false, selected: false, dirchange: false, title: "Productos" },
