...
// Stock data
let stock = [...Stockdata.StockTable]
    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <SwiperjsCards :swiperItems="Stockdata.StockData" swiperClass="swiper stocks-swiper swiper-initialized swiper-horizontal swiper-backface-hidden"
                    ...
                    <div class="d-flex align-items-center gap-3 p-3 rounded border border-dashed flex-wrap">
                        <div>
                            <span class="avatar avatar-lg avatar-rounded">
                                <BaseImg src="/images/media/apps/apple.png" alt="" class="invert-1" />
                        ...
                        <li v-for="(idx) in Stockdata.Recentstocks" :key="idx.id">
                            <div class="d-flex gap-2 flex-wrap align-items-start justify-content-between mb-2">
                                <div class="d-flex flex-fill align-items-center">
                                    <div class="me-2">
                                        <span class="avatar avatar-md p-1">
                                            <BaseImg :src="idx.logo" alt="" :class="idx.bgClass" />
                                        </span>
                                    </div>
                                    <div class="lh-1">
                                        <span class="fw-semibold d-block mb-2 text-default">{{ idx.name }}</span>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <TableComponent tableClass="table text-nowrap"
                                ...
                                <div class="d-flex align-items-start gap-3">
                                    <div class="lh-1">
                                        <span class="avatar avatar-sm">
                                            <BaseImg :src="row.logo" alt="" :class="row.bgCustomClass" />
                                        </span>
                                    </div>
                            ...
                            <td>
                                <div class="btn-list">
                                    <a href="javascript:void(0);" class="btn btn-icon btn-primary-light btn-sm"><i
                                            class="bi bi-pencil-square"></i></a>
                                    <a href="javascript:void(0);" class="btn btn-icon btn-danger-light btn-sm"
                                        @click="handleToDelete(row.id)"><i class="bi bi-trash"></i></a>
                                </div>
                            </td>
                        </TableComponent>
                    </div>
