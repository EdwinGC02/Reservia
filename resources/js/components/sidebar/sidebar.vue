        ...
        <PerfectScrollbar class="main-sidebar" id="sidebar-scroll">
            ...
            <nav class="main-menu-container nav nav-pills flex-column sub-open">
                ...
                <ul class="main-menu">
                    <li v-for="(mainmenuItem, index) in menuData" :key="index"
                        ...
                        <template v-if="mainmenuItem?.type === 'link'">
                            <Link :href="mainmenuItem.path" class="side-menu__item"
                        ...
                        <template v-if="mainmenuItem?.type === 'sub'">
                            <RecursiveMenu :menuData="mainmenuItem" :toggleSubmenu="toggleSubmenu"
                ...
                <ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
                    ...
                    <!-- Start::slide -->
                    <li class="slide">
                        <Link :href="`${baseUrl}/pages/profile`" class="side-menu__item p-1 rounded-circle mb-0">
    ...
    for (const mutation of mutationsList) {
        if (mutation.type === 'attributes' && mutation.attributeName === 'data-nav-layout') {
            ...
            if (newValue == 'vertical') {
                let currentPath = window.location.pathname.endsWith('/') ? window.location.pathname.slice(0, -1) : window.location.pathname;
