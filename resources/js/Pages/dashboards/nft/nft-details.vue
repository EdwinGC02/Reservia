                            ...
                            <div class="row">
                                <div class="col-xxl-12 col-sm-12 mb-md-5 mb-3">
                                    <swiper :autoplay="true" :style="{
                                        ...
                                        <swiper-slide><BaseImg class="img-fluid rounded" src="/images/nft-images/14.png" /></swiper-slide>
                                        <swiper-slide><BaseImg class="img-fluid rounded" src="/images/nft-images/13.png" /></swiper-slide>
                                        <swiper-slide><BaseImg class="img-fluid rounded" src="/images/nft-images/12.png" /></swiper-slide>
                                        <swiper-slide><BaseImg class="img-fluid rounded" src="/images/nft-images/10.png" /></swiper-slide>
                                    </swiper>
                                    <swiper :autoplay="true" @swiper="setThumbsSwiper" :spaceBetween="10"
                                        ...
                                        <swiper-slide><BaseImg class="img-fluid" src="/images/nft-images/14.png" /></swiper-slide>
                                        <swiper-slide><BaseImg class="img-fluid" src="/images/nft-images/13.png"/></swiper-slide>
                                        <swiper-slide><BaseImg class="img-fluid" src="/images/nft-images/12.png"/></swiper-slide>
                                        <swiper-slide><BaseImg class="img-fluid" src="/images/nft-images/10.png" /></swiper-slide>
                                    </swiper>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><BaseImg
                                                            ...
                                                            <div class="d-flex flex-fill">
                                                                <div class="me-2">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <BaseImg src="/images/nft-images/14.png" alt=""/>
                                                                    </span>
                                                                </div>
                                                                <div class="lh-1 me-2">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="products-review-images">
                                                                        <a href="javascript:void(0);">
                                                                            <BaseImg src="/images/nft-images/44.png" alt=""/>

                                                                        </a>
                                                                        <a href="javascript:void(0);">
                                                                            <BaseImg src="/images/nft-images/18.png" alt=""/>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div
